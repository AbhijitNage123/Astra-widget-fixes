...
if ( ! class_exists( 'Astra_Widget_Address' ) ) :
	...
	class Astra_Widget_Address extends WP_Widget {
		...
		function register_scripts() {
			...
			wp_enqueue_script( 'astra-widgets-backend',ASTRA_WIDGETS_URI .'assets/js/unminified/' . 'astra-widgets-backend'. '.js', array( 'jquery' ), ASTRA_WIDGETS_VER, true );
		}

		/**
		 * Print widget scripts.
		 *
		 * @since 1.0.0
		 */
		public function print_scripts() {
			...
			<script>
				...
				( function( $ ){
					console.log(widget..find( '.astra-widget-field-color input' ));
					function initColorPicker( widget ) {

						widget.find( '.astra-widget-field-color input' ).wpColorPicker( {
					...
					$( document ).ready( function() {
						$( '#widgets-right .widget:has(.astra-widget-field-color input)' ).each( function () {
		...
		// Colors
		$color1 = ( ! empty( $instance['color1'] ) ) ? $instance['color1'] : '#000';
				...
				<address class="widget-address widget-address-<?php echo esc_attr( $style ); ?> widget-address-icons-<?php echo esc_attr( $social_icons ); ?>" >
					...
					<?php if ( ! empty( $phone ) ) { ?>
						<div class="widget-address-field">
							<?php if ( $social_icons ) { ?>
									<?php // Font Awesome 5 SVG. ?>
									<svg xmlns="http://www.w3.org/2000/svg" class="address-icons" width="<?php echo $widget_content_font_size . 'px'; ?>" height="<?php echo $widget_content_font_size . 'px'; ?>" viewBox="0 0 512 512" style="fill:<?php echo $color1; ?>"><path d="M493.4 24.6l-104-24c-11.3-2.6-22.9 3.3-27.5 13.9l-48 112c-4.2 9.8-1.4 21.3 6.9 28l60.6 49.6c-36 76.7-98.9 140.5-177.2 177.2l-49.6-60.6c-6.8-8.3-18.2-11.1-28-6.9l-112 48C3.9 366.5-2 378.1.6 389.4l24 104C27.1 504.2 36.7 512 48 512c256.1 0 464-207.5 464-464 0-11.2-7.7-20.9-18.6-23.4z"
										></path>
									</svg>
								</span>
							<?php } ?>
					...
					<?php if ( ! empty( $fax ) ) { ?>
						<div class="widget-address-field">
							<?php if ( $social_icons ) { ?>
									<?php // Font Awesome 5 SVG. ?>
									<svg xmlns="http://www.w3.org/2000/svg" class="address-icons" width="<?php echo $widget_content_font_size . 'px'; ?>" height="<?php echo $widget_content_font_size . 'px'; ?>" viewBox="0 0 384 512" style="fill:<?php echo $color1; ?>"><path d="M224 136V0H24C10.7 0 0 10.7 0 24v464c0 13.3 10.7 24 24 24h336c13.3 0 24-10.7 24-24V160H248c-13.2 0-24-10.8-24-24zm160-14.1v6.1H256V0h6.1c6.4 0 12.5 2.5 17 7l97.9 98c4.5 4.5 7 10.6 7 16.9z"></path>
									</svg>
								</span>
							<?php } ?>
					...
					if ( ! empty( $email ) ) {
						...
						<div class="widget-address-field">
							<?php if ( $social_icons ) { ?>
									<?php // Font Awesome 5 SVG. ?>
									<svg xmlns="http://www.w3.org/2000/svg" class="address-icons" width="<?php echo $widget_content_font_size . 'px'; ?>" height="<?php echo $widget_content_font_size . 'px'; ?>" viewBox="0 0 512 512" style="fill:<?php echo $color1; ?>"><path d="M502.3 190.8c3.9-3.1 9.7-.2 9.7 4.7V400c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V195.6c0-5 5.7-7.8 9.7-4.7 22.4 17.4 52.1 39.5 154.1 113.6 21.1 15.4 56.7 47.8 92.2 47.6 35.7.3 72-32.8 92.3-47.6 102-74.1 131.6-96.3 154-113.7zM256 320c23.2.4 56.6-29.2 73.4-41.4 132.7-96.3 142.8-104.7 173.4-128.7 5.8-4.5 9.2-11.5 9.2-18.9v-19c0-26.5-21.5-48-48-48H48C21.5 64 0 85.5 0 112v19c0 7.4 3.4 14.3 9.2 18.9 30.6 23.9 40.7 32.4 173.4 128.7 16.8 12.2 50.2 41.8 73.4 41.4z"></path>
									</svg>
								</span>
							<?php } ?>
							<span class="address-meta">
		...
		<p>
			...
			<input type="text" name="<?php echo $this->get_field_name( 'color1' ); ?>" class="astra-widget-field-color" id="<?php echo $this->get_field_id( 'color1' ); ?>" value="<?php echo $color1; ?>" data-default-color="#fff" />
		</p>
			<?php
